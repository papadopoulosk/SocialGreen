	...
	*/
	...
	function Move(){ 
		...
		if($secondBG.hasClass("inview")){
			...
			bg2.css({'backgroundPosition': newPos(70, windowHeight, pos, 2410, 0.2)});
			//call the newPos function and change the second background position
		}
		...
		if ($fourthBG.hasClass("inview")){
			...
			//19-11-2013 bg4.css({'backgroundPosition': newPos(50, windowHeight, pos, 6210, 0.20)});
			bg4.css({'backgroundPosition': newPos(50, windowHeight, pos, 4210, 0.20)});
		}
